...
SECRET_KEY = 'django-insecure-z$1*f!2=5!mp$dll6vxy&y(d5he8leau01801fg-mj=b6n(0)i'
...
# Add the following line to include the custom authentication backend
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'info@hanseltech.co.ke'
EMAIL_HOST_PASSWORD = 'Kewas2023'